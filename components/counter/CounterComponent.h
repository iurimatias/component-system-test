#ifndef NEDRYSOFT_COUNTER_COUNTERCOMPONENT_H
#define NEDRYSOFT_COUNTER_COUNTERCOMPONENT_H

#include "CounterSpec.h"
#include <QObject>
#include <IComponent>

class NEDRYSOFT_COUNTER_DLLSPEC CounterComponent :
        public QObject,
    ...
    public:
        /**
         * @brief       Constructs the CounterComponent.
         */
        CounterComponent();

        /**
         * @brief       Destroys the CounterComponent.
         */
        ~CounterComponent();
...
#endif // NEDRYSOFT_COUNTER_COUNTERCOMPONENT_H 